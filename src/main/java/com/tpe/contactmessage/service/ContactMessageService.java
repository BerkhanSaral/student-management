...
public class ContactMessageService {
    ...
    /*   public ResponseMessage<String> deleteByIdParam(Long id) {

        ContactMessage contactMessage = findById(id);

        contactMessageRepository.delete(contactMessage);

        return ResponseMessage.<String>builder().message("Contact Message Delete Successfully").httpStatus(HttpStatus.OK).build();
...
*/
    ...
    /*  public ResponseMessage<ContactMessageResponse> getByIdWithParam(Long id) {

        ContactMessage contactMessage = findById(id);

        return ResponseMessage.<ContactMessageResponse>builder().message("Contact Message Getting Successfully").httpStatus(HttpStatus.OK) // 201
                .object(createContactMessage.contactMessageToResponse(contactMessage)).build();

    }*/

    /* public ContactMessage findById(Long id) {

        return contactMessageRepository.findById(id).orElseThrow(() -> new RuntimeException("id not found : " + id));
